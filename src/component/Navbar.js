...
const [nav, setNav]=useState(false)
  ...
  return (
    <navbar className='max-w-[1640px] mx-auto flex justify-between 
    items-center p-4'>
        ...
        <div className='bg-gray-200 rounded-full flex items-center
            ...
            itmes-center py-2 rounded-full'>
            ...
            <div className={ nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300':'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}>
              ...
              top-4 cursor-pointer' onClick={()=>setNav(!nav)} />
              ...
              <nav>
                <ul className='flex flex-col p-4 text-gray-800'>
                  ...
                  <li className='text-xl py-4 flex '>
                    <FaUserFriends size={25} className='mr-4'/> Best One
                  </li>
                  <li className='text-xl py-4 flex '>
                    <BsFillSaveFill size={25} className='mr-4'/> Invite Friends
                  </li>
                </ul>
              </nav>
            </div>
